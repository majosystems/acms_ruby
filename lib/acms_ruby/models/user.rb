...
module AcmsRuby
  class User < ARBase
    belongs_to :blog, class_name: 'Blog', foreign_key: :user_blog_id, primary_key: :blog_id

    has_many :entries, class_name: 'Entry', foreign_key: :entry_user_id, primary_key: :user_id
    has_many :fields, class_name: 'Field', foreign_key: :field_uid, primary_key: :user_id
